<%@ Page Title="" Language="C#" MasterPageFile="~/User/User.Master" AutoEventWireup="true" CodeBehind="Cart.aspx.cs" Inherits="restaurant.User.Cart" %>
            ...
            <asp:Repeater ID="rCartItem" runat="server" OnItemCommand="rCartItem_ItemCommand" OnItemDataBound="rCartItem_ItemDataBound">
                                ...
                                <div class="quantity">
                                    <div class="pro-qty">
                                        ...
                                        <asp:RegularExpressionValidator ID="revQuantity" runat="server" ErrorMessage="*" ForeColor="Red" Font-Size="Small"
                                           ValidationExpression="0*[1-9][0-9]*" ControlToValidate="txtQuantity" Display="Dynamic" SetFocusOnError="true" EnableClientScript="true"></asp:RegularExpressionValidator>
                                    </div>
                                </div>
                            </div>
                        </td>
                ...
                <FooterTemplate>
                    <tr>
                        ...
                        <td> ₹<%: Session["grandTotalPrice"] %> </td>
                        <td></td>
                    </tr>
                    <tr>
                        <td colspan="2" class="continue__btn">
                            <a href="menu.aspx" class="btn btn-info"><i class="fa fa-arrow-circle-left mr-2"></i>Continue Order</a>
                        </td>
                        <td>
                            <asp:LinkButton ID="lbUpdatedCart" runat="server" CommandName="UpdateCart" CssClass="btn btn-warning">
                                <i class="fa fa-refresh mr-2"></i>Update Cart
                            </asp:LinkButton>
                        </td>
                        <td>
                            <asp:LinkButton ID="lbCheckout" runat="server" CommandName="Checkout" CssClass="btn btn-success">Checkout<i class="fa fa-arrow-circle-right ml-2 "></i>
                            </asp:LinkButton>
                        </td>
                    </tr>
                    </tbody>
