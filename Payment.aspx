<%@ Page Title="" Language="C#" MasterPageFile="~/User/User.Master" AutoEventWireup="true" CodeBehind="Payment.aspx.cs" Inherits="restaurant.User.Payment" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
     ...
     <section class="book_section" style="background-image: url('../Images/pament.jfif'); width: 100%; height: 100%; background-repeat: no-repeat; 
