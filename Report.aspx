<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/Admin.Master" AutoEventWireup="true" CodeBehind="Report.aspx.cs" Inherits="restaurant.Admin.Report" %>
                                    ...
                                    <div class="container">
                                        <div class="form-row">
                                            <div class="form-group col-md-4">
                                                ...
                                                <asp:RequiredFieldValidator ID="rfvFromDate" Display="Dynamic" runat="server" ForeColor="Red" ErrorMessage="*" SetFocusOnError="true"
                                            ...
                                            <div class="form-group col-md-4">
                                                <label>To Date</label>
                                                <asp:RequiredFieldValidator ID="rfvToDate" Display="Dynamic" runat="server" ForeColor="Red" ErrorMessage="*" SetFocusOnError="true"
